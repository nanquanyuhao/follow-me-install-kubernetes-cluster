...
替换后的 kube-proxy.config.yaml 文件：[kube-proxy.config.yaml](./systemd/kube-proxy.config.yaml)
...
替换后的 unit 文件：[kube-proxy.service](./systemd/kube-proxy.service)
...
tcp        0      0 192.168.235.123:10256   0.0.0.0:*               LISTEN      898/kube-proxy      
tcp        0      0 192.168.235.123:10249   0.0.0.0:*               LISTEN      898/kube-proxy      
tcp6       0      0 :::8652                 :::*                    LISTEN      898/kube-proxy
```
...
TCP  10.254.0.1:443 rr persistent 10800
  -> 192.168.235.123:6443         Masq    1      0          0         
  -> 192.168.235.124:6443         Masq    1      0          0         
  -> 192.168.235.125:6443         Masq    1      0          0         
>>> 192.168.235.124
IP Virtual Server version 1.2.1 (size=4096)
Prot LocalAddress:Port Scheduler Flags
  -> RemoteAddress:Port           Forward Weight ActiveConn InActConn
