...
确认各 work 节点的 docker0 网桥和 flannel.1 接口的 IP 处于同一个网段中(如下 172.30.33.0 和 172.30.33.1)：

``` bash
3: flannel.1: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1450 qdisc noqueue state UNKNOWN 
    link/ether ce:a0:30:16:c4:69 brd ff:ff:ff:ff:ff:ff
    inet 172.30.33.0/32 scope global flannel.1
       valid_lft forever preferred_lft forever
4: docker0: <NO-CARRIER,BROADCAST,MULTICAST,UP> mtu 1500 qdisc noqueue state DOWN 
    link/ether 02:42:bd:e8:b5:ef brd ff:ff:ff:ff:ff:ff
    inet 172.30.33.1/24 brd 172.30.33.255 scope global docker0
       valid_lft forever preferred_lft forever
```